...
function Customers() {
  ...
  return (
    <div className="min-h-screen bg-background pb-6">
      ...
      {(initClassFilter !== 'all' || initType) && (classFilter !== 'all' || selectedTypes.length > 0) && (
        <div className="px-6 py-3 bg-primary/10 flex items-center justify-between">
          <div className="text-base text-primary flex items-center gap-2">
            ...
            <span>已筛选: <span className="font-bold">{classFilter !== 'all' ? classFilter : selectedTypes.join(', ')}</span></span>
          </div>
          <button
            type="button"
            onClick={() => {
