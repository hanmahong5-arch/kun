...
import {getCustomerById, updateCustomer} from '@/db/api'
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      if (data) {
        ...
        setCompanyDevelopment(data.company_development || '')
        setCooperationDirection(data.cooperation_direction || '')
        setCooperationHistory(data.cooperation_history || '')
  ...
  return (
    <div className="min-h-screen bg-background pb-6">
      ...
      <div className="bg-gradient-primary px-6 py-6">
        <div className="text-2xl text-primary-foreground font-bold">编辑客户</div>
        <div className="text-base text-primary-foreground/80 mt-1">修改客户信息</div>
      </div>
